...
namespace MVC_BusTicket.Extensions
{
    public static class SessionExtension
    {
        ...
        public static void SetTicketAsJson(this ISession session, string key, Ticket value)
        {
        ...
        public static Ticket GetTicketFromJson(this ISession session, string key)
        {
